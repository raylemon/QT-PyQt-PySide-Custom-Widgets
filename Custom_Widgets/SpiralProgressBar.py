...
class spiralProgressBar(QtWidgets.QWidget):
    ...
    def convValue(self, value, pos):
        ...
        self.spb_value[pos] = ((value - self.spb_minimValue[pos]) / (
    ...
    def paintEvent(self, event: QPaintEvent):
        ...
        if self.pathPresent:
            for path in range(0, self.noProgBar, 1):
                ...
                self.pathPainter.drawArc(self.positionX + self.posFactor + self.spb_cngSize * spiralIncrem2,
        ...
        for bar in range(0, self.noProgBar, 1):
            ...
            self.linePainter.drawArc(self.positionX + self.posFactor + self.spb_cngSize * spiralIncrem,
